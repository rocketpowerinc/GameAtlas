...
],games:[{id:'one',values:{title:'Example','legacy-link':'https://youtu.be/video','price':25,priority:['Want soon','Someday']},dateEnd:'2027-02-03',dateIsTime:0,lookup:{description:'It&#x27;s fun &amp; polished.',sources:[{name:'Wikipedia',url:'https://en.wikipedia.org/wiki/Example'}]}}]};
...
assert.deepEqual(orderedSources([{name:'Website',url:'site'},{name:'Wikipedia',url:'wiki'},{name:'IGN',url:'ign'},{name:'HowLongToBeat',url:'hltb'},{name:'Steam',url:'steam'},{name:'YouTube',url:'youtube'}]).map(source=>source.name),['YouTube','IGN','Steam','Wikipedia','HowLongToBeat','Website']);
