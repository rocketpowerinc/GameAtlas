 ...
 if(smoke){
  try{
   ...
   await window.webContents.executeJavaScript(`(async()=>{
    ...
    if(document.querySelectorAll('.game-badge-choice').length!==4||!document.querySelector('.game-badge-picker')?.textContent.includes('Play with Kids'))throw Error('Badge editor missing');
