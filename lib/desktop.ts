declare global {interface Window {gameAtlas:{request:(path:string,method:string,body?:unknown)=>Promise<{ok:boolean;data:any;warning?:string}>;exportBackup:()=>Promise<string>;restoreBackup:()=>Promise<boolean>;chooseBackupFolder:()=>Promise<boolean>;openBackups:()=>Promise<string>}}}
